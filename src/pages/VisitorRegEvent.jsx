    ...
    try {
      const { data } = await client.post(
        "/registerVisitorForEvent",
        {
          ...
          ...extra,
          has_car,
          user_id: getOriginalParam(id),
          event_name: getOriginalParam(event),
        },
        {
          headers: {
            Authorization: getOriginalParam(id),
          },
        }
      );
        ...
        <div className="flex justify-center md:items-center border -md:h-[100vh] -md:w-full border-gray-300 bg-white shadow-lg rounded">
          <div className="p-10">
            <div
              ...
              className="text-blue-800/70 font-semibold text-center text-lg -md:mt-10 mb-10 capitalize wrap"
            >
              {getOriginalParam(event)} Attendee Registration
            </div>
            <Formik
              initialValues={{
                name: "",
...
export default VisitorRegEvent;
